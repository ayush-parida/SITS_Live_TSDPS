...
import com.sitslive.sitsliveschool.ui.notices.NoticesDataObject;
import com.sitslive.sitsliveschool.ui.notices.NoticesRecyclerViewAdapter;
...
public class NoticesActivity extends AppCompatActivity {
    ...
    private ArrayList<NoticesDataObject> getDataSet() {
        ArrayList results = new ArrayList<NoticesDataObject>();
        for (int index = 0; index < x; index++) {
            NoticesDataObject obj = new NoticesDataObject("Fee Due No: "+Date.get(index),"Issue Date: "+FeeFor.get(index),
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, test, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    mAdapter = new NoticesRecyclerViewAdapter(getDataSet());
