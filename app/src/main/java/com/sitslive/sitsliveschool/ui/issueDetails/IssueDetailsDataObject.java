...
public class IssueDetailsDataObject {
    ...
    IssueDetailsDataObject(String feeFor, String date, String totalAmount/*, String totalReceive, String totalDue, String balance*/) {
        mFeeFor=feeFor;
        mDate=date;
